...
public class MainActivity extends AbstractNavDrawerActivity implements
	...
	void initUpdateDialog() {
		if (NetworkAvailability.networkStatus(this)) {
			...
			UpdateDialogHelper.UpdateCanceledDialog(this, getResources()
					.getString(R.string.update_error), "");
	}

	void addFragments() {
		getFragmentManager().beginTransaction().add(R.id.content_frame, cam)
				.commit();
		getFragmentManager().beginTransaction().add(R.id.content_frame, scale)
				.commit();
		getSupportFragmentManager().beginTransaction()
				.add(R.id.content_frame, calendar).commit();
		getFragmentManager().beginTransaction().add(R.id.content_frame, chat)
				.commit();
		getFragmentManager().beginTransaction()
				.add(R.id.content_frame, presence).commit();
	}
	...
	protected NavDrawerActivityConfiguration getNavDrawerConfiguration() {
		...
		NavDrawerItem[] menu = new NavDrawerItem[] {
				...
				NavMenuItem.create(2, getResources().getString(R.string.chat),
						true, this),
				NavMenuItem
						.create(3, getResources().getString(R.string.calendar),
								true, this),
				NavMenuItem.create(4,
						getResources().getString(R.string.statistic), true,
						this),
				NavMenuItem.create(5,
						getResources().getString(R.string.live_image), true,
						this),
				NavMenuItem.create(6,
						getResources().getString(R.string.website_link), true,
						this) };
	...
	void startWebsite() {
		Intent browserIntent = new Intent(Intent.ACTION_VIEW,
				Uri.parse(AppConfig.server.WEBSITE_URL));
	...
	public void onUpdateFinished() {
		...
		UpdateDialogHelper.dismissUpdateDialog(this,
	...
	public void onLocalDataError(String description) {
		// TODO Auto-generated method stub
		UpdateDialogHelper.UpdateCanceledDialog(this,
				getResources().getString(R.string.update_local_data_error),
				description);
	}
}
