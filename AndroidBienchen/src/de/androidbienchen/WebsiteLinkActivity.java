...
public class WebsiteLinkActivity extends AbstractNavDrawerActivity  {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.website_link, menu);
		return true;
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_website_link,
					container, false);
			return rootView;
		}
	}
    ...
    protected NavDrawerActivityConfiguration getNavDrawerConfiguration() {
        ...
        NavDrawerItem[] menu = new NavDrawerItem[] {
                ...
                NavMenuItem.create(6, "Website", "navdrawer_webite", true, this),};
